...
//
//		int[] labelCounts = new int[data.getLabels().size()];
//		for (Example e : data.getData()) {
//			labelCounts[(int) e.getLabel()]++;
//		}
//
//		double max = 0;
//		for (int i = 0; i < labelCounts.length; i++) {
//			System.out.println("i: " + i + " " + labelCounts[i]);
...
//		System.out.println(max / data.getData().size());
//
//		double correct = 0, t = 0;
//
//		for (Example e : data.getData()) {
//			if (e.getLabel() == dt.classify(e)) {
//				correct++;
//			}
//			t++;
//		}
...
//		System.out.println(correct / t);
		...
		for (int i = 0; i <= 50; i++) {
			...
			dt1.setDepthLimit(i);
			dt1.train(split.getTrain());

			double c = 0, a = 0;
			for (Example e : split.getTest().getData()) {
				a++;
				if (dt1.classify(e) == e.getLabel()) {
					c++;
				}
			}
			...
			System.out.println("Depth limit: " + i + " test accuracy: " + c / a + " train accuracy: " + c1 / a1);
			s += "(" + i + ", " + Math.floor(c / a * 100000) / 1000 + ")\n";
			s1 += "(" + i + ", " + Math.floor(c1 / a1 * 100000) / 1000 + ")\n";
		}
